      ...
      <div className="login-box">
        ...
        <form onSubmit={handleRegister} className="login-form">
          <div className="input-group">
            ...
            <Input type={email} id={email} value={email} onChange={(e) => setEmail(e.target.value)} classNam={"input-field"} required/>
          </div>
          <div className="input-group">
            <label htmlFor="username">Username</label>
            <Input type={username} id={username} value={username} onChange={(e) => setUsername(e.target.value)} classNam={"input-field"} required/>
          </div>
